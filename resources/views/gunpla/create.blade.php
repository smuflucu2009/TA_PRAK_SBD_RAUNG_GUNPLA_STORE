...
@section('inti_data')
<h1 style="color: rgb(255, 255, 255);">Buat Data Gundam</h1>
...
<form action='{{url('/gunpla')}}' method='post'>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='id_gunpla' value="{{ Session::get('id_gunpla')}}" id="id_gunpla">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="nama_gunpla" class="col-sm-2 col-form-label">Nama Gunpla</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='nama_gunpla' value="{{ Session::get('nama_gunpla')}}" id="nama_gunpla">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="grade" class="col-sm-2 col-form-label">Grade</label>
            <div class="col-sm-10">
                <select class="form-select" aria-label="Default select example" name='grade' value="{{ Session::get('grade')}}" id="grade">
